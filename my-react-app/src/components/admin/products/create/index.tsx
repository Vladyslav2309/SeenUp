...
const CreateProduct = () => {
  ...
  const onSubmitFormik = async (values: ICreateProduct) => {
    try {
      ...
      await http.post("/api/products", values);
  ...
  return (
      <>
        <section className="flex items-center justify-center m-2 max-w-7xl mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
          <div className="flex justify-center">
            ...
            <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-full">
