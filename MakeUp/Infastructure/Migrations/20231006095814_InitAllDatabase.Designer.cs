...
namespace Infastructure.Migrations
{
    ...
    [Migration("20231006095814_InitAllDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.BasketEntity", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.OrderItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.OrderStatusEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.ProductImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.SaleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.SaleProductEntity", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.OrderEntity", b =>
                {
                    b.HasOne("Core.Entities.OrderStatusEntity", "OrderStatus")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Core.Entities.SaleProductEntity", b =>
                {
                    ...
                    b.HasOne("Core.Entities.SaleEntity", "Sale")
                        .WithMany("SaleProducts")
